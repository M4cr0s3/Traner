...
import {definePageMeta, useNotification} from "#imports";
...
const handleRegister = async (formData: IRegisterData) => {
    const data: Ref<IUserResponse | null> = await register(formData)
...
<template>
    <div class="min-w-screen min-h-screen gradiented flex items-center justify-center px-5 py-5">
            ...
            <div class="md:flex w-full">
                <div class="hidden md:block w-1/2 bg-white py-10 px-10">
                    <svg id="a87032b8-5b37-4b7e-a4d9-4dbfbe394641" data-name="Layer 1"
                        ...
                        <circle id="a4813fcf-056e-4514-bb8b-e6506f49341f" data-name="Ellipse 1" cx="364.43401"
                                cy="261.50202" r="24.45" fill="#FF4C00"/>
                        ...
                        <circle id="fcef55fc-4968-45b2-93bb-1a1080c85fc7" data-name="Ellipse 2" cx="225.46401"
                                cy="427.41999" r="6.902" fill="#FF4C00"/>
                        ...
                        <circle id="e8fa0310-b872-4adf-aedd-0c6eda09f3b8" data-name="Ellipse 3" cx="225.46401"
                                cy="496.43702" r="6.902" fill="#FF4C00"/>
                        <path
                            ...
                            transform="translate(-227.576 -76.46149)" fill="#FF4C00"/>
                ...
                <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                    <div class="text-center mb-10">
                        <h1 class="font-bold text-3xl uppercase gradient">регистрация</h1>
                        <p class="text-brown text-sm font-gilroy-regular">Введите вашу информацию для регистрации</p>
                    </div>
                    <form>
                        <div class="flex -mx-3">
                        ...
                        <div class="flex -mx-3">
                            <div class="w-full flex-col px-3 mb-5">
                                <UIButton @click.prevent="handleRegister(formData)"
                                          class="w-full gradiented text-white">
                                    Зарегистрироваться
                                </UIButton>
                            </div>
                        </div>
